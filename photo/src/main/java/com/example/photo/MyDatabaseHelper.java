...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    private static final String CREATE_TABLE = "create table currentTime(time varchar,id int);";
    private static final String CREATE_PIC = "create table pic(picValue blob);";
